...
// function TaskList({ tasks, users, updateTask, deleteTask }) {
...
//                                     >
//                                         Move to {nextStatus[task.status]} <FaArrowRight />
//                                     </button>
//                                 )}
...
function TaskCard({ task, users, deleteTask, onMoveTask, disabled }) {
    const dragRef = useRef(null);

    // Simple drag handlers using the native HTML5 Drag and Drop API
